...
from monitoring.views.motors import data_motor, add_data_motor, edit_data_motor, del_data_motor, export_motor_excel, import_motor_data, download_sample_motor
...
urlpatterns = [
    ...
    path("import-motor/", import_motor_data, name="import_motor"),
    path("download-sample-motor/", download_sample_motor, name="download_sample_motor"),
